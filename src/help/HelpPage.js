...
import { DefaultCthulhuCharacter } from "../character/DefaultCuthuluCharacter";
    ...
    <Stack spacing={3}>
      ...
      <Typography variant={"p"} sx={{ whiteSpace: "pre-line" }}>
        ...
        <Accordion>
          <AccordionSummary
            expandIcon={<ExpandMoreIcon />}
            id="default-cthulhu-char"
          >
            <Typography>Cthulhu Character</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography>
              <Paper elevation={0}>
                <Typography sx={{ whiteSpace: "break-spaces" }}>
                  {yaml.dump(DefaultCthulhuCharacter)}
                </Typography>
              </Paper>
            </Typography>
          </AccordionDetails>
